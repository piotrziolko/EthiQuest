...
export class Migration20240312182323 extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('create table "template" ("uuid" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "data" jsonb null, constraint "template_pkey" primary key ("uuid"));');
